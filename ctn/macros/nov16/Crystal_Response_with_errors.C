...
////																									   
////	It studies the ratio of an isotropic and a correlated distribution in simulation					
...
////		2nd: root -l Crystal_Response_with_errors.C									
////
////	This Macro reads:																				
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  for(Int_t i = 0; i < nLevel; i++){ 
    ...
    cout<<"Ratio_relativeError_CryId_"<<i+1<<"= "<<Error_Gammas[i]<<endl;
  }
